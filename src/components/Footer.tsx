      ...
      <div className="container flex items-center justify-around w-full h-full  px-4">
        <div className="flex flex-col md:flex-row justify-between items-center w-full">
          ...
          <div className="flex space-x-6 w-full justify-center">
            <Link href="/conserjeria" className="text-gray-300 hover:text-white">
              <svg
                className="w-6 h-6"
                fill="currentColor"
                viewBox="0 0 24 24"
            ...
            <Link href="/empresa" className="text-gray-300 hover:text-white">
              <svg
                className="w-6 h-6"
                fill="currentColor"
                viewBox="0 0 24 24"
            ...
            <Link href="/inmobiliaria" className="text-gray-300 hover:text-white">
              <svg
                className="w-6 h-6"
                fill="currentColor"
                viewBox="0 0 24 24"
